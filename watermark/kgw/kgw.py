...
class KGW(BaseWatermark):
    ...
    def batch_generate_watermarked_tokens(self, inputs: torch.LongTensor, *args, **kwargs) -> torch.LongTensor:
    ...
    def detect_watermark_tokens(self, inputs: torch.LongTensor, return_dict: bool = True, *args, **kwargs):
        ...
        if return_dict:
            return {"is_watermarked": is_watermarked, "score": z_score, "p_value": p_value}
        else:
    ...
    def detect_watermark(self, text: str, return_dict: bool = True, *args, **kwargs):
        ...
        p_value = 1 - 0.5 * torch.erfc(torch.tensor(z_score, dtype=torch.float64) / torch.sqrt(torch.tensor(2.0)))
